...
const works: Record<string, Work> = {
  minertia: {
    ...
    caseStudies: [
      ...
      {
        label: "技術",
        title: "DDDとMVVMで、変更に耐える構造へ。",
        body: "DDDでゲーム内の概念とルールを整理し、MVVMで責務を分離。Unityへの依存を抑え、インタラクションをC#側で管理しました。",
        stack: "Unity・C#",
        notes: [
          {
            name: "UIToolkit",
  ...
  sphere: {
    ...
    caseStudies: [
      ...
      {
        label: "技術",
        title: "DOTSで、描画性能を引き上げる。",
        body: "Unity、C#、UGUIに加え、DOTSの低レベルAPIを用いて、ゲームロジックと連携する独自ParticleSystemを実装しました。",
        stack: "Unity・C#・UGUI・DOTS",
      },
      {
        label: "次への課題",
        title: "分担すると、全体の完成度が見えなくなる。",
        body: "描画性能は改善した一方、UIとゲームロジックを担当者で分けた体制では、ゲーム全体の完成度を一貫して判断しにくい問題が残りました。",
      },
    ],
    scope: [
  ...
  spiral: {
    ...
    caseStudies: [
      ...
      {
        label: "技術",
        title: "螺旋を描き、チーム開発の作法を覚える。",
        body: "Unity、C#、UGUIを使用。螺旋描画にはLineRendererを用い、チーム開発に必要なデザインパターンも実務の中で習得しました。",
        stack: "Unity・C#・UGUI・LineRenderer",
      },
      {
        label: "次への課題",
        title: "描画負荷と、属人化した管理が残る。",
        body: "CPU側で行う螺旋描画の負荷、Prefab管理の属人性、UIとゲームロジックの距離を次作へ持ち越しました。",
      },
    ],
    scope: [
      { number: "01", field: "設計", title: "UI・グラフィック", detail: "主担当として画面とビジュアルを設計。" },

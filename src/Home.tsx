...
const works: Record<string, Work> = {
  ...
  sphere: {
    ...
    facts: [
      ...
      { term: "成績", value: "累計 約6.1万DL／App Store 3.9" },
    ],
    metricsNote: "App Store 3.51万／Google Play 25,554（2026年7月確認）",
    aspect: "landscape",
    images: [
  ...
  spiral: {
    ...
    facts: [
      ...
      { term: "開発環境", value: "Unity・C#・UGUI" },
      { term: "成績", value: "累計 約8.3万DL／Steam 非常に好評（1,871件）" },
    ],
    metricsNote: "App Store 4.08万／Google Play 42,036（2026年7月確認）",
    aspect: "landscape",
    images: [
